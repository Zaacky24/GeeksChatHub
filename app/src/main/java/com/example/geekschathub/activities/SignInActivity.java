...
import com.example.geekschathub.databinding.ActivitySignInBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add this line to set the listeners
        setListeners();
    }
    ...
    private void signIn(){
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                .whereEqualTo(Constants.KEY_EMAIL, binding.EditName.getText().toString())
    ...
    private Boolean isValidSignInDetails() {
        ...
        else if (!Patterns.EMAIL_ADDRESS.matcher(binding.EditName.getText().toString()).matches()) {
